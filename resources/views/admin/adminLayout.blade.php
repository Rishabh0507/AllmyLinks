...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <img src="{{asset('dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">MyAllLinks</span>
    </a>
...
<script>
    ...
    var modal = $(this)
    modal.find('.modal-title').text('User Access of  ' + name)
    modal.find('.modal-body #userId').val(id)
    modal.find('.modal-body #userName').val(name)
    modal.find('.modal-body #userAccess').val(access)
  })
  </script>
